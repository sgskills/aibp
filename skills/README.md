...
当前源码与稳定安装包版本均为 `3.0.7`，可从 [AIBP Latest Release](https://github.com/sgskills/aibp/releases/latest) 下载，已包含 30 天惰性检查更新功能。仓库与安装包采用平台中立的 Agent Skill 结构；具体 Runtime 兼容性仍以实机验证为准。
